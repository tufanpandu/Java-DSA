...
class Trie_1 {
    ...
    public static void insert(String word) {
        ...
        // Every Node main jo End of Word false the by default usko agar word khatam
        // hota hai tha End of Word ko true kar denge.
        curr.endOfWord = true;
    ...
    public static boolean search(String key) {
        ...
        for (int level = 0; level < key.length(); level++) {
            ...
            if (curr.children[idx] == null) { // if character index is not present in root children then we simpley
                                              // return false.
                return false;
            }
    ...
    public static boolean wordBreak(String key) {
        ...
        for (int i = 1; i <= key.length(); i++) {
            ...
            // Check if the substring from 0 to i is present in the trie and if the rest of
            // the string can be broken down into words
