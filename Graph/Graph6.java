...
public class Graph6 {
    ...
    public static boolean isCycle(ArrayList<Edge>[] graph) {
        ...
        for(int i =0 ;i< graph.length;i++){
            //Check first component of graphs and check first vertex of graph is it visited.
    ...
    public static boolean isCycleUtil(ArrayList<Edge>[] graph, int curr, boolean vist[], boolean stack[]) {
        ...
        for(int i =0 ; i< graph[curr].size();i++){
          ...
          // Else if still we are not visiting in neighbour and then call recursively isCycleUtil function and if this function return true . then cycle exisit.
